...
//    }
    ...
    fun populateDB(){
        CoroutineScope(Dispatchers.IO).launch {
            localData.insert(Assignment(UUID.randomUUID(), "assignment1", "Assignment #1", "cs,programming",
            ...
            localData.insert(Assignment(UUID.randomUUID(),"assignment2", "Assignment #2", "cs,programming",
                "Linguagens Programação I", "edu.someUniversity.cs1.Assignment2",
                "git@github.com:someuser/cs1Assignment2.git", "Java",
                "0",getCurrentDateAndTime() ,""))
            localData.insert(Assignment(UUID.randomUUID(),"assignment3", "Assignment #3", "cs,programming",
                "Algoritmia e Estruturas de Dados", "edu.someUniversity.cs1.Assignment3",
                "git@github.com:someuser/cs1Assignment3.git", "Java",
                "0",getCurrentDateAndTime() ,""))
            localData.insert(Assignment(UUID.randomUUID(),"assignment4", "Assignment #4", "cs,programming",
